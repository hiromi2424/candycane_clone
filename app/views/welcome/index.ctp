<h2><?php $this->Candy->html_title(__('Home', true))  ?></h2>
...
<div class="splitcontentleft">
  ...
  <div class="box">
	<h3><?php __('Latest news')?></h3>
		<?php echo $this->element('news', compact('news')) ?>
		<?php echo $this->Html->link(__('View all news', true), array('controller' => 'news', 'action' => 'index')) ?>
  </div>
  <?php endif; ?>
</div>
...
<div class="splitcontentright">
	...
	<h3 class="icon22 icon22-projects"><?php __('Latest projects') ?></h3>
		...
		<?php foreach ($projects as $project): ?>
			<li>
			<?php echo $this->Html->link($project['Project']['name'], array('controller' => 'projects', 'action' => 'show', $project['Project']['identifier'])) ?>(<?php echo $this->Candy->format_time($project['Project']['created_on']) ?>)
